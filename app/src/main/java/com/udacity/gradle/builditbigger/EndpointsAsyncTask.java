...
/**
 * Created by lsitec207.neto on 23/11/17.
 */
...
public class EndpointsAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        Intent intentJokeActivity = new Intent(mainActivity.getApplicationContext(),JokeActivity.class);
        //intentJokeActivity.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
